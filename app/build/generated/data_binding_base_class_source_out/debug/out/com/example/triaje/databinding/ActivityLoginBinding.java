...
public final class ActivityLoginBinding implements ViewBinding {
  ...
  private ActivityLoginBinding(@NonNull ConstraintLayout rootView, @NonNull Button buttonLogin,
      ...
      @NonNull ImageView imageView, @NonNull LinearLayout socialLoginButtons,
      @NonNull TextView textEmail, @NonNull TextView textPassword, @NonNull TextView textView,
      @NonNull TextView textViewCreateAccount) {
    this.rootView = rootView;
    this.buttonLogin = buttonLogin;
    this.editTextEmail = editTextEmail;
    this.editTextPassword = editTextPassword;
    this.imageView = imageView;
    this.socialLoginButtons = socialLoginButtons;
  ...
  public static ActivityLoginBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.socialLoginButtons;
      LinearLayout socialLoginButtons = ViewBindings.findChildViewById(rootView, id);
      ...
      return new ActivityLoginBinding((ConstraintLayout) rootView, buttonLogin, editTextEmail,
          editTextPassword, imageView, socialLoginButtons, textEmail, textPassword, textView,
